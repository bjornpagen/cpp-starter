...
|---|---|---|---|---|---|
| [126782](https://gcc.gnu.org/bugzilla/show_bug.cgi?id=126782) | `[Darwin] sys/_types/_rsize_t.h does not define rsize_t with -fmodules` | target | UNCONFIRMED | `awaiting-send-approval` | Local `git format-patch` is in [`gcc-fixincludes-darwin-rsize-t`](gcc-fixincludes-darwin-rsize-t/). Public send is blocked until Bjorn approves `APPROVAL-PACKET.md` for SHA-256 `385acc6a7a51883837234427e18dd877712cced040bff6972077a9f084d786de`. Do not comment on Bugzilla before the gcc-patches archive shows the mail. |
