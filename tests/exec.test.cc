...
auto check_value_chain() -> CaseResult {
	return CaseResult{
...
auto check_error_recovery() -> CaseResult {
	return CaseResult{
...
auto check_error_reroute() -> CaseResult {
	return CaseResult{
...
auto check_error_passthrough() -> CaseResult {
	return CaseResult{
...
auto check_pool_when_all() -> CaseResult {
	return CaseResult{
...
auto check_variant_roundtrip() -> CaseResult {
	return CaseResult{
...
auto check_stopped_as_optional_value() -> CaseResult {
	return CaseResult{
...
auto check_stopped_as_optional_stopped() -> CaseResult {
	return CaseResult{
